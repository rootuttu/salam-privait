...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="https://telegra.ph/file/974be2632f12842755400.jpg" type=image/jpg">
    <script
...
<body>
  <!--© Designed and coded by @bipuldey19-Telegram-->
    <header>
      <div class="brand">
        <img
          src="https://telegra.ph/file/974be2632f12842755400.jpg"
          alt="logo"
        />
        <a href="https://t.me/Xcodershub"> 
          <h2 class="name">GD Mirror Bot</h2>
        </a>
      </div>
      <div class="social">
        <a href="https://github.com/AmirulAndaib"><i class="fab fa-github"></i></a>
...
<body>
   <!--© Designed and coded by @bipuldey19-Telegram-->
    <header>
      ...
      <div class="social">
        <a href="https://github.com/AmirulAndalib"><i class="fab fa-github"></i></a>
        <a href="https://t.me/Xcodershub"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <section>
...
@routes.get('/gdbot/files/{hash_id}')
async def list_torrent_contents(request):
    ...
    if not "pin_code" in gets.keys():
        rend_page = code_page.replace("{form_url}", f"/gdbot/files/{torr}")
    ...
    rend_page = rend_page.replace(
        "{form_url}", f"/gdbot/files/{torr}?pin_code={pincode}")
    client.auth_log_out()
    return web.Response(text=rend_page, content_type='text/html')
...
@routes.post('/gdbot/files/{hash_id}')
...
async def homepage(request):
    ...
    return web.Response(text='<h1>🤗GD mirror BOT webserver is Up and Running successfully🟢</h1>\n<h2>🥲Join Xcodershub <a href="https://t.me/XcodersHub">TG channel</a></h2>',content_type="text/html",)
    ...
    async def middleware_handler(request):
        ...
        try:
            ...
            if response.status == 404:
                return web.Response(text="<h1>404: Page not found</h1>", content_type="text/html")
            return response
