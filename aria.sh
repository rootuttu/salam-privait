...
aria2c --enable-rpc --rpc-listen-all=false --check-certificate=false \
   ...
   --bt-tracker="[$tracker_list]" --bt-max-peers=0 --bt-tracker-connect-timeout=230 --bt-stop-timeout=260 --min-split-size=10M \
   ...
   --peer-id-prefix=-qB4370- --user-agent=qBittorrent/4.3.7 --peer-agent=qBittorrent/4.3.7 \
